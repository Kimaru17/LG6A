...
public interface Queue {
    ...
    public void enQueue(Object element, Integer priority) throws QueueException; //encola un elemento por el extremo posterior, de acuerdo al a prioridad indicada
